...
price_per_cup = float(input("Enter the price per cup in dolllars: "))
cup_sold = int(input("Enter the number fo cups sold: "))
...
amount_paid= float(input("Enter thr amount paid by the customer: "))
